                    ...
                    style={{
                        ...
                        top: `${position.y}px`
                            ...
                            <div className='text-center  my-[10%]  w-full '>
                                        ...
                                        <Link to='/relationtoothers'><h1 className=' text-black text-center text-6xl font-bold  text-sm ' onClick={() => { props.setContact(false); dispatch(relationtoothers());  }}  > <span className=''>In Relation to others</span></h1></Link>
