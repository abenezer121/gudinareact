...
const Navbar = () => {
  ...
  return (
     ...
     <div style={{ ...navbarStyles, top: visible ? '0' : '-60px' }} className='w-full h-[70px]  z-10 bg-transparent fixed top-0 text-white'>
            ...
            <div className='px-3 w-full flex justify-between items-center w-full h-full'>
                ...
                <div className='flex items-center h-full'>
                    <ul className='hidden md:flex space-x-4'>
                            <li className={ 'text-black-800 text-sm uppercase '} > Home</li>
                            <li className={'text-black-800 text-sm uppercase'}> His Idiology</li>
                            <li className={ 'text-black-800 text-sm uppercase' } >In Relation to other</li>
                            <li className={ 'text-black-800 text-sm uppercase' } >Papers</li>
                            <li className={'text-black-800 text-sm uppercase'} >Archive</li>
                            <li className={'text-black-800 text-sm uppercase'} >Gallery</li>
...
//     return (
//         <>
//             {show ?  <nav> <p>first</p> <p>second</p> <p>third</p> </nav> : ""}
       
//         </>
         
//         // <div className='w-full h-[70px]  z-10 bg-purple-900/90 fixed top-0 text-white'>
