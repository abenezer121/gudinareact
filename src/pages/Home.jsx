                ...
                <div className="grid md:grid-cols-1 lg:grid-cols-2 w-full h-full">
                  <div className="mx-20">
                    <div data-aos="fade-up" data-aos-delay="600">
                        <h1 className="text-4xl font-bold"   data-aos="fade-up">Life of Rev. Gudina</h1>
                ...
                <div className="grid md:grid-cols-1 lg:grid-cols-2 w-full h-full">
                  ...
                  <div className="mx-20 mt-3">
                    ...
                    <h2 className="text-left mt-20"   data-aos="fade-up">
                      <ReadMore>
                          Gudina accepted the truth at the age of ten, and from the first time that he heard it, he began to defend it. The first instance of Gudina defending the truth, is when he cut down a ritual worship tree and tried to tell his townspeople to accept the Gospel.
                          His defense of this truth continued during his pastoral service in Nekemte when he clashed with a Church elder who practiced infidelity, he defended the truth again when he stood up against covert colonial practices seen in his criticism of certain Western Mission Organizations. He zeal for truth is seen again when he refused a liturgical prayer– A prayer that is read
                          to glorify the Emperor and ensure the continuity of his reign without any consideration for justice– Gudina believed in praying for the nation and its leader, but the prayer he wanted to pray for the emperor was one of repentance on behalf of those facing injustice. The biggest stance for the truth that Gudina took
                          was when he refused to deny that the Derg–A
                          socialist Ethiopian regime– was oppressing human and religious rights. This was his last and most notable defense of the truth. This stance made him lose his freedom, family and even his life. Gudina’s fervor for defending the truth made him a martyr for Christ.
            ...
            <div className="my-auto w-[100%]">
                ...
                >
                  ...
                  <div className="ml-[40px] md:ml-[80px]">
                    <div className=" w-full   grid   grid-cols-3 md:grid-cols-6   " >
